...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $sql = "SELECT * FROM lab WHERE name ='$name'";
$result = $conn->query($sql);
    if ($result->num_rows === 0) {

    $sql = "INSERT INTO lab (name, amount, date, hospital_id) VALUES ('$name','$amount','$date', '$hospital_id')";
    ...
    $sql = "UPDATE lab SET amount = '$amount' WHERE name = '$name'";
    if ($conn->query($sql) === TRUE) {
