  ...
  <section>
    ...
    <div class="main-products">
        <form class="man" method="post">
            ...
            <label for="amount">Consultation price</label>
...
$result = $conn->query($sql);
    ...
    $sql = "INSERT INTO consultation (name, amount, date, hospital_id) VALUES ('$name','$amount','$date', '$hospital_id')";
    ...
    $sql = "UPDATE consultation SET amount = '$amount' WHERE name = '$name'";
    if ($conn->query($sql) === TRUE) {
