  ...
  <section>
    ...
    <div class="main-products">
        <form class="man" method="post">
            ...
            <label for="amount">IWF price</label>
...
$sql = "CREATE TABLE IF NOT EXISTS iwf (
...
$result = $conn->query($sql);
    ...
    $sql = "INSERT INTO iwf (name, amount, date, hospital_id) VALUES ('$name','$amount','$date', '$hospital_id')";
    ...
    $sql = "UPDATE iwf SET amount = '$amount' WHERE name = '$name'";
    if ($conn->query($sql) === TRUE) {
