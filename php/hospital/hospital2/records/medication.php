  ...
  <section>
    ...
    <div class="main-products">
        <form class="man" method="post">
            ...
            <label for="amount">Medication price</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $sql = "SELECT * FROM medication WHERE name ='$name'";
$result = $conn->query($sql);
    if ($result->num_rows === 0) {

    $sql = "INSERT INTO medication (name, amount, date, hospital_id) VALUES ('$name','$amount','$date', '$hospital_id')";
    ...
    $sql = "UPDATE medication SET amount = '$amount' WHERE name = '$name'";
    if ($conn->query($sql) === TRUE) {
