...
<body>
    ...
    <header>ST. THERESE MEDICAL CENTER NOMAYOS</header>
...
$sql = "CREATE TABLE IF NOT EXISTS phisiotherapy (
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $sql = "SELECT * FROM phisiotherapy WHERE name ='$name'";
$result = $conn->query($sql);
    if ($result->num_rows === 0) {

    $sql = "INSERT INTO phisiotherapy (name, amount, date, hospital_id) VALUES ('$name','$amount','$date', '$hospital_id')";
    ...
    $sql = "UPDATE phisiotherapy SET amount = '$amount' WHERE name = '$name'";
    if ($conn->query($sql) === TRUE) {
