...
$sql = "CREATE TABLE IF NOT EXISTS bedfees (
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $sql = "SELECT * FROM bedfees WHERE name ='$name'";
$result = $conn->query($sql);
    if ($result->num_rows === 0) {

    $sql = "INSERT INTO bedfees (name, amount, date, hospital_id) VALUES ('$name','$amount','$date', '$hospital_id')";
    ...
    $sql = "UPDATE bedfee SET amount = '$amount' WHERE name = '$name'";
    if ($conn->query($sql) === TRUE) {
