  ...
  <section>
    ...
    <div class="main-products">
        <form class="man" method="post">
            ...
            <label for="amount">Dentistry price</label>
...
$sql = "CREATE TABLE IF NOT EXISTS dentistry (
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $sql = "SELECT * FROM dentistry WHERE name ='$name'";
$result = $conn->query($sql);
    if ($result->num_rows === 0) {

    $sql = "INSERT INTO dentistry (name, amount, date, hospital_id) VALUES ('$name','$amount','$date', '$hospital_id')";
    ...
    $sql = "UPDATE dentistry SET amount = '$amount' WHERE name = '$name'";
    if ($conn->query($sql) === TRUE) {
