...
<body>
    ...
    <li class="item "><a href="\fts\php\admin\main-dashboard.php" class="itemLink "><i class="fas fa-tachometer-alt" id="icon"></i>Dashboard</a></li>
             <li class="item"><a href="#" class="itemLink" onclick="toggleSubOptions()"><i class="fas fa-money-bill" id="icon"></i>BUDGET</a>
                ...
                <ul class="sublist" id="subOptions">
                    <li class="item"><a href="\fts\php\admin\addBudget.php" class="sublink"><i class="fas fa-plus-circle" id="icon"></i>Add Budget</a></li>
          ...
          <li class="hov item"><a href="#" class="itemLink" onclick="toggleSubOptions2()"><i class="fas fa-product" id="icon"></i>EXPENSES</a>
                <ul class="sublist" id="subOptions2">
                    <li class="item"><a href="\fts\php\admin\expense.php" class="hov sublink"><i class="fas fa-plus-circle" id="icon"></i>Add Expeses</a></li>
    ...
    <section>
        <br>
        <br>
    <h3><a class="addd" href="\fts\php\admin\viewExpense.php" >View Expense</a></h3>
    <div class="case">
    <div class="main-products">
        <form class="man" method="post">
            <h1>Add New Depreciation</h1>
            <label for="name">Depreciation Name</label>
...
$sql = "CREATE TABLE IF NOT EXISTS depreciation (
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO depreciation (name, amount, date) VALUES ('$name','$amount','$date')";

    if ($conn->query($sql) === TRUE) {
        echo '<div class="success-message" id="success-message">depreciation added successfully!</div>';
