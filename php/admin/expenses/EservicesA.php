...
<body>
    ...
    <div class="main-products">
        <form class="man" method="post">
            <h1>Add New Externat Service</h1>
...
$sql = "CREATE TABLE IF NOT EXISTS serviceA (
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO serviceA (name, amount, date) VALUES ('$name','$amount','$date')";

    if ($conn->query($sql) === TRUE) {
        echo '<div class="success-message" id="success-message">serviceA added successfully!</div>';
