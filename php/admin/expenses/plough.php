...
<body>
    ...
    <div class="main-products">
        <form class="man" method="post">
            <h1>Add New Plough Back</h1>
            <label for="name">plough ack Name</label>
...
$sql = "CREATE TABLE IF NOT EXISTS plough (
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO plough (name, amount, date) VALUES ('$name','$amount','$date')";

    if ($conn->query($sql) === TRUE) {
        echo '<div class="success-message" id="success-message">plough added successfully!</div>';
