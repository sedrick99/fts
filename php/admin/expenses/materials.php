...
<body>
    ...
    <div class="main-products">
        <form class="man" method="post">
            ...
            <label for="amount">Material Cost</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO materials (name, amount, date) VALUES ('$name','$amount','$date')";

    if ($conn->query($sql) === TRUE) {
        echo '<div class="success-message" id="success-message">materials added successfully!</div>';
