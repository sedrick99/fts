...
function renderTable($conn, $tableName, $title)
{
    ...
    echo "</table>
          <hr>
          <div class='buts'>
            <button class='neww'><a style='color: white; text-decoration: none;' href='budget/$tableName.php'>Add New</a></button>
...
<body>
    ...
    <div class="sidebar">
        <ul class="list">
          ...
          <li class="hov item"><a href="#" class="itemLink" onclick="toggleSubOptions()"><i class="fas fa-money-bill" id="icon"></i>BUDGET</a>
